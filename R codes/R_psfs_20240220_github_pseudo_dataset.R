...
data1 <- data.frame(baby_id=1:5000,
                   ...
                   mother_age=round(runif(5000, min=4825, max=21223)),
                   ses=sample(c("LOW","HIGH","MEDIUMLOW","MEDIUMHIGH"), 5000, replace=TRUE),
                   birth_year=sample(2001:2014, 5000, replace=TRUE),
                   ...
                   renal_disease=rbinom(5000, 1, 0.01),
                   crohn_disease=rbinom(5000, 1, 0.01),
                   sleep_disorder=rbinom(5000, 1, 0.01),
                   scz=rbinom(5000, 1, 0.01),
                   bipolar=rbinom(5000, 1, 0.01),
                   personality_disorder=rbinom(5000, 1, 0.005),
                   intellectual_disability=rbinom(5000, 1, 0.01),
                   psy_development_disorder=rbinom(5000, 1, 0.01),
                   illicit_drug=rbinom(5000, 1, 0.01),
                   adhd_asd=rbinom(5000, 1, 0.001),
                   thyroid_disorder=rbinom(5000, 1, 0.01),
                   rheumatoid_arthristis=rbinom(5000, 1, 0.01),
                   headache=rbinom(5000, 1, 0.01),
                   smoke=rbinom(5000, 1, 0.01),
                   drink=rbinom(5000, 1, 0.01),
                   baby_sex=sample(c("F","M"), 5000, replace=TRUE),
                   preterm_birth=rbinom(5000, 1, 0.01),
...
data_unweighted <- data1_1 %>% 
  mutate(y2001=ifelse(birth_year==2001,1,0),
         ...
         y2015=ifelse(birth_year==2015,1,0),
         y2016=ifelse(birth_year==2016,1,0),
         y2017=ifelse(birth_year==2017,1,0),
         y2018=ifelse(birth_year==2018,1,0),
